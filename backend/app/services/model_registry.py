...
_WORKLOAD_LABELS = MappingProxyType({
    ...
    "query_rewrite": "查询改写",
    "gap_consult_query": "站外来源检索词规划",
    "external_evidence_answer": "站外摘要补充",
...
_WORKLOAD_ANALYSIS_AREAS: Mapping[str, ModelAnalysisArea] = MappingProxyType({
    ...
    "reasoning_agent": "ask",
    "query_rewrite": "ask",
    "gap_consult_query": "ask",
    "external_evidence_answer": "ask",
    "evidence_refine": "ask",
...
_CHAT_THINKING_DEFAULTS: Mapping[
    ...
    "gap_consult_query": "disabled",
    "external_evidence_answer": "disabled",
...
WORKLOADS = workload_map(
    chat={
        ...
        "gap_consult_query": "interactive",
        "external_evidence_answer": "interactive",
        "report_outline": "report",
