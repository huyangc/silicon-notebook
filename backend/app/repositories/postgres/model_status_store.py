...
class ModelStatusStore:
    """PostgreSQL deployment-wide model-service health observations."""
    ...
    def get_all(self) -> dict[str, dict[str, object]]:
        ...
        return {
            str(row["service_id"]): {
                ...
                "checked_at": row["checked_at"].astimezone(timezone.utc).isoformat(
        ...
        *,
        ...
        with self.database.write() as db:
            db.execute(
                ...
                "support_id, checked_at) VALUES (%s,%s,%s,%s,%s,%s,%s,%s) "
