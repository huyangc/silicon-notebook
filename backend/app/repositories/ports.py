...
class AskCandidatePort(Protocol):
    ...
    def retrieve_chunk_candidates(self, notebook_id: str, query: str) -> tuple[Any, Any, Any]: ...
    def retrieve_chunk_candidates_multi(self, notebook_id: str, queries: list[str]) -> tuple[Any, Any, Any, Any]: ...
    def mixed_chunk_candidates(self, notebook_id: str, query: str, high_level: str, queries: list[str]) -> tuple[Any, Any, Any, Any, int]: ...
    def merge_chunk_candidates(self, base: list[RetrievedChunk], extra: list[RetrievedChunk]) -> list[RetrievedChunk]: ...
    def select_chunk_candidates(self, scored: list[RetrievedChunk], ids: Any, matrix: Any, k: int, lambda_: float) -> list[RetrievedChunk]: ...
...
class SQLiteMaintenancePort(Protocol):
    ...
    def latest_extraction_run(self, source_id: str) -> dict | None: ...
    def seed_parsed_source(self, notebook_id: str, *, title: str, doc_type: str, file_name: str, file_path: str, elements: Sequence[dict], status: str = "extracted") -> str: ...
    def seed_rule_object(self, notebook_id: str, *, payload: dict, evidence: list, source_id: str) -> str: ...
    def invalidate_unified_cache(self, notebook_id: str) -> None: ...
    ...
    def embed_objects_batch(self, notebook_id: str, items: list[dict], progress: Any = None, commit_every: int | None = None) -> None: ...
    def knowledge_object_payloads(self, notebook_id: str, *, include_deprecated: bool = False) -> list[dict]: ...
    def backfill_node_embeddings(self, notebook_id: str, progress: Any = None) -> int: ...
    ...
    def mark_unified_kg_dirty(self, notebook_id: str) -> None: ...
    def relations_with_names(self, notebook_id: str, relation_ids: list | None = None) -> list[dict]: ...
    def knowledge_context(self, notebook_id: str, hits: Sequence[Any]) -> tuple: ...
    def load_scale_index(self, notebook_id: str, allow_stale: bool = False) -> Any: ...
    ...
    def latest_done_report(self) -> dict | None: ...
    ...
    def convert_text_vector_batch(self, table: str, id_col: str, notebook_id: str | None, batch_size: int, encode: Callable[[list], list]) -> tuple: ...
    def clear_source_index(self, notebook_id: str) -> int: ...
    def backfill_source_index_batch(self, notebook_id: str, last_id: str, batch_size: int) -> tuple: ...
