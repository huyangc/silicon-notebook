...
class NotebookStorePort(Protocol):
    ...
    def participant_ids(self, db: object, active_notebook_id: str) -> list[str]: ...
    def participant_rows(self, db: object, active_notebook_id: str) -> tuple[Any, list[Any]]: ...
    def participant_tiers(self, db: object, active_notebook_id: str) -> tuple[list[str], dict[str, str]]: ...
...
class SourceStorePort(Protocol):
    ...
    def retrieval_element_rows(self, db: object, notebook_id: str) -> list[Any]: ...
...
class ChunkStorePort(Protocol):
    def language_probe_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def retrieval_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def count_row(self, db: object, notebook_id: str) -> Any: ...
    def hydrate_rows(self, db: object, chunk_ids: Sequence[str]) -> list[Any]: ...
    def graph_hydrate_rows(self, db: object, chunk_ids: Sequence[str]) -> list[Any]: ...
    def id_element_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def rows_by_ids(self, db: object, chunk_ids: Sequence[str]) -> list[Any]: ...
    def id_rows(self, db: object, notebook_id: str) -> list[Any]: ...


@runtime_checkable
class EmbeddingStorePort(Protocol):
    def bind_write(self, write: Callable) -> None: ...
    def embedded_object_ids(self, db: object, notebook_id: str) -> set[str]: ...
    def version_row(self, db: object, notebook_id: str, table: str) -> Any: ...
    def vector_rows(self, db: object, notebook_id: str, table: str, id_col: str) -> list[Any]: ...
    def vector_rows_for_ids(self, db: object, notebook_id: str, table: str, id_col: str, ids: Sequence[str]) -> list[Any]: ...
    def relation_delta_rows(self, db: object, notebook_id: str, source_ids: Sequence[str]) -> list[Any]: ...
    def knowledge_delta_rows(self, db: object, notebook_id: str, source_ids: Sequence[str]) -> list[Any]: ...
    def element_delta_rows(self, db: object, notebook_id: str, source_ids: Sequence[str]) -> list[Any]: ...
    def chunk_delta_rows(self, db: object, notebook_id: str, source_ids: Sequence[str]) -> list[Any]: ...
    def rows_by_ids(self, db: object, table: str, id_col: str, ids: Sequence[str]) -> list[Any]: ...


@runtime_checkable
class KnowledgeStorePort(Protocol):
    def active_object_count(self, db: object, notebook_id: str) -> int: ...
    def community_context_rows(self, db: object, notebook_id: str, members: object) -> list[Any]: ...
    def delete_notebook_graph_rows(self, db: object, notebook_id: str) -> None: ...
    def embedding_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def embedding_rows_for_objects(self, db: object, notebook_id: str, object_ids: object) -> list[Any]: ...
    def incremental_object_rows(self, db: object, notebook_id: str, source_id: str, object_type: str, *, exclude_source: bool = False) -> list[Any]: ...
    def insert_kg_fts_rows(self, connection: object, rows: object) -> None: ...
    def insert_object_chunk(self, connection: object, rows: object) -> None: ...
    def insert_object_source_rows(self, connection: object, rows: object) -> None: ...
    def insert_relation_chunk(self, connection: object, rows: object) -> None: ...
    def neighbor_relation_rows(self, db: object, notebook_id: str, object_ids: object) -> list[Any]: ...
    def notebook_tier_row(self, db: object, notebook_id: str) -> Any: ...
    def object_meta_rows_for_notebook(self, db: object, notebook_id: str, object_ids: object) -> list[Any]: ...
    def relink_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def source_build_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def sources_with_elements(self, db: object, notebook_id: str) -> list[Any]: ...
    def unified_graph_rows(self, db: object, notebook_id: str) -> object: ...
    ...
    def replace_object_sources(connection: object, object_id: str, notebook_id: str, evidence_json: str | None) -> None: ...
...
class UnifiedKgStorePort(Protocol):
    def canonical_relation_seed_rows(self, db: object, notebook_id: str) -> object: ...
    def canonical_relations_count(self, db: object, notebook_id: str) -> int: ...
    def checkpoint_put(self, notebook_id: str, input_version: str, stage: str, rows: object, now: str) -> None: ...
    def clear_mention_bridge(self, db: object, notebook_id: str) -> None: ...
    def clear_scratch_run(self, db: object, notebook_id: str, run_id: str) -> None: ...
    def cluster_description_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def cluster_evidence_rows(self, db: object, notebook_id: str, run_id: str, seeds: object) -> list[Any]: ...
    def cluster_input_facts(self, db: object, notebook_id: str, *, exclude_emb_count: bool = False) -> object: ...
    def communities_count(self, db: object, notebook_id: str, level: int) -> int: ...
    def community_graph_rows(self, db: object, notebook_id: str) -> object: ...
    def community_member_ids(self, db: object, notebook_id: str, level: int) -> list[Any]: ...
    def community_reports(self, db: object, notebook_id: str, level: int) -> list[Any]: ...
    def community_rows_for_summary(self, db: object, notebook_id: str, level: int) -> list[Any]: ...
    def concept_clusters_count(self, db: object, notebook_id: str) -> int: ...
    def distinct_cluster_count(self, db: object, notebook_id: str) -> int: ...
    def finish_rebuild_state(self, db: object, notebook_id: str, cluster_input_version: str, cluster_count: int, now: str) -> None: ...
    def insert_scratch_rows(self, db: object, rows: object) -> None: ...
    def mention_edges_count(self, db: object, notebook_id: str) -> int: ...
    def mention_seed_rows(self, db: object, notebook_id: str) -> object: ...
    def replace_canonical_relations(self, db: object, notebook_id: str, rows: object, seq: int) -> None: ...
    def replace_cluster_rows_streamed(self, db: object, notebook_id: str, object_type: str, rows: object) -> None: ...
    def replace_communities(self, db: object, notebook_id: str, level: int, kept: object, names: object, deg: object, now: str) -> None: ...
    def replace_mention_bridge(self, db: object, notebook_id: str, edges: object, comention_rows: object, seq: int) -> None: ...
    def scratch_vector_rows(self, db: object, notebook_id: str, run_id: str) -> object: ...
    def seed_payload_rows(self, db: object, notebook_id: str, object_type: str) -> object: ...
    def set_community_seq(self, db: object, notebook_id: str, seq: int) -> None: ...
    def set_community_summary(self, db: object, community_id: str, title: str, summary: str, findings_json: str) -> None: ...
    def state_row(self, db: object, notebook_id: str) -> Any: ...
    def stream_scratch_rows(self, db: object, notebook_id: str, run_id: str) -> object: ...
    def stream_seed_rows(self, db: object, notebook_id: str, object_type: str) -> object: ...
    def mention_alias_candidates(
        self, claims: Sequence[tuple[str, str]], aliases: Sequence[str]
    ) -> dict[str, list[tuple[str, str]]]: ...
    def cluster_version_row(self, db: object, notebook_id: str) -> Any: ...
    def cluster_member_rows(self, db: object, notebook_id: str) -> list[Any]: ...
    def ppr_version_rows(self, db: object, notebook_id: str) -> tuple[Any, Any, Any, Any, Any]: ...
    def mention_rows(self, db: object, notebook_id: str) -> list[Any]: ...
...
class GovernanceStorePort(Protocol):
    def delete_clusters(self, connection: object, notebook_id: str, object_type: str) -> None: ...
    def delete_pending_merges(self, connection: object, notebook_id: str) -> None: ...
    ...
    def insert_pending_merge_rows(self, connection: object, rows: object) -> None: ...
    def merge_candidate_pairs(self, db: object, notebook_id: str, statuses: object) -> list[Any]: ...
    def valid_object_ids(self, db: object, object_ids: object) -> set[str]: ...
    def seed_for(object_type: str): ...
    def merge_evidence(base_evidence: list, source_evidence: list) -> list: ...
    def sweep_orphan_clusters(self, db: object, notebook_id: str) -> int: ...
    def incremental_cluster_rows(
        self, db: object, notebook_id: str, object_type: str
    ) -> list[Any]: ...
    def update_edge_review(
        self, connection: object, notebook_id: str, relation_id: str, status: str
    ) -> None: ...
...
class QueryStorePort(Protocol):
    def count_rows(self, db: object, table: str, column: str, value: str) -> int: ...
    def list_user_usage(self) -> list[dict[str, Any]]: ...
    def list_user_notebooks(self, user_id: str) -> list[dict[str, Any]]: ...
    def notebook_analytics(self, notebook_id: str) -> NotebookAnalytics: ...
    def pending_actions_projection_rows(self, user_id: str) -> dict: ...
