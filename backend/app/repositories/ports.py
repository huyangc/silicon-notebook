...
class RetrievalKnowledgeStorePort(KnowledgeStorePort, Protocol):
    def fts_search(self, db: object, notebook_id: str, q: str, k: int = 30, *, allowed_source_ids: Sequence[str] | None = None) -> list[dict[str, Any]]: ...
    def chunk_fts_search(self, db: object, notebook_id: str, q: str, k: int = 30, *, allowed_source_ids: Sequence[str] | None = None) -> list[dict[str, Any]]: ...
