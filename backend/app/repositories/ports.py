...
class RetrievalKnowledgeStorePort(KnowledgeStorePort, Protocol):
    ...
    def any_mounted_has_kg_on(self, db: sqlite3.Connection, notebook_id: str) -> bool: ...
...
class SQLiteMaintenancePort(Protocol):
    ...
    def sources_with_completed_parse(self, notebook_id: str) -> set[str]: ...
    def sources_with_chunks(self, notebook_id: str) -> set[str]: ...
    def sources_in_flight_parse(self, notebook_id: str) -> set[str]: ...
