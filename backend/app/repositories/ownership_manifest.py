...
SURFACE_MEMBERS = (
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/tests/test_batch_ingest.py', scope='<module>.test_no_signal_conversion_on_paths_that_do_not_drain', kind='patch', target='rebuild_unified_kg'),
