...
SURFACE_MEMBERS = (
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/tests/test_batch_ingest.py', scope='<module>.test_non_durable_paths_keep_default_termination_signals', kind='patch', target='rebuild_unified_kg'),
