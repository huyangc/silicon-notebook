...
SURFACE_MEMBERS = (
    ...
    SurfaceMember(
        name='_invalidate_checkup_missing_vector_counts',
        owner='CheckupService',
        kind='private_wrapper',
        consumers=(
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.__init__', kind='attribute', target='_invalidate_checkup_missing_vector_counts'),
        ),
        patches=(
        ),
    ),
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.resolve_reasoning_followup', kind='attribute', target='_runtime'),
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>.apply_plan', kind='attribute', target='current_user'),
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>._discard_unreferenced', kind='attribute', target='maintenance'),
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>._source_pages', kind='attribute', target='maintenance'),
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>.apply_plan', kind='attribute', target='maintenance'),
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>.plan_for_source', kind='attribute', target='maintenance'),
    ...
    SurfaceMember(
        ...
        kind='method',
        consumers=(
            ConsumerSite(path='backend/app/api/mcp_tools/sources.py', scope='<module>.register_source_tools.reparse_source.run', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/api/source_routes.py', scope='<module>._backfill_vectors_job', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/api/source_routes.py', scope='<module>.backfill_vectors', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/api/source_routes.py', scope='<module>.reparse_sources', kind='attribute', target='require_indexing_pipeline_write'),
            ...
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.build_scale_index', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.extract_source', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.fold_scale_index_delta', kind='attribute', target='require_indexing_pipeline_write'),
            ...
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.parse_source', kind='attribute', target='require_indexing_pipeline_write'),
            ...
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.relink_notebook_kg', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.run_conflict_resolution_job', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.run_notebook_relink_job', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.run_unified_kg_rebuild_job', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.start_conflict_resolution', kind='attribute', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/app/services/repository_facade.py', scope='<module>.RepositoryFacade.start_notebook_relink', kind='attribute', target='require_indexing_pipeline_write'),
            ...
            ConsumerSite(path='backend/tests/test_kg_repository.py', scope='<module>.test_extract_source_delegates_to_run_extraction', kind='patch', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/tests/test_knowledge_lifecycle_delegation.py', scope='<module>.test_facade_lifecycle_methods_delegate_to_the_runtime_instance', kind='patch', target='require_indexing_pipeline_write'),
        ),
        patches=(
            ConsumerSite(path='backend/tests/test_kg_repository.py', scope='<module>.test_extract_source_delegates_to_run_extraction', kind='patch', target='require_indexing_pipeline_write'),
            ConsumerSite(path='backend/tests/test_knowledge_lifecycle_delegation.py', scope='<module>.test_facade_lifecycle_methods_delegate_to_the_runtime_instance', kind='patch', target='require_indexing_pipeline_write'),
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>.apply_plan', kind='attribute', target='settings'),
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>.plan_for_source', kind='attribute', target='settings'),
            ConsumerSite(path='backend/app/services/image_backfill_phase.py', scope='<module>.run_backfill_images', kind='attribute', target='settings'),
    ...
    SurfaceMember(
        ...
        kind='method',
        consumers=(
            ConsumerSite(path='backend/app/api/knowhow_routes.py', scope='<module>._prepare_knowhow_cell_task', kind='attribute', target='validate_cell_target'),
