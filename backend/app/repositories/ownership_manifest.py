...
SURFACE_MEMBERS = (
    ...
    SurfaceMember(
        ...
        consumers=(
            ...
            ConsumerSite(path='backend/app/services/sqlite_repository.py', scope='<module>.SQLiteRepository.chat', kind='attribute', target='_runtime'),
            ConsumerSite(path='backend/app/services/sqlite_repository.py', scope='<module>.SQLiteRepository.close', kind='attribute', target='_runtime'),
            ...
            ConsumerSite(path='backend/app/services/sqlite_repository.py', scope='<module>.SQLiteRepository.configured', kind='attribute', target='_runtime'),
            ...
            ConsumerSite(path='backend/app/services/sqlite_repository.py', scope='<module>.SQLiteRepository.knowhow_history_page', kind='attribute', target='_runtime'),
            ...
            ConsumerSite(path='scripts/backfill_kg_embeddings.py', scope='<module>.main', kind='attribute', target='_runtime'),
        ),
        patches=(
        ),
    ),
