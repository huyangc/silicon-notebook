...
def test_schema_version_constant_is_v16():
    ...
    # 索引 v15 migration 与 knowhow-tables PR-1 Task 1 的五张新表 v16 migration
    # 均保留；与 facade 模块级 SCHEMA_VERSION、test_follow_chain 守卫同步。
