...
REASONING_REFLECT_PROSE_DETAIL_ENABLED # bounded high-relevance source-passage detail plus first-visible-excerpt feedback, only in prefix_delta_evidence; false restores the arm's preceding prose projection. Does not enable v2 or choose an optimization arm
