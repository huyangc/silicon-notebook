...
- Boundary regression tests use public HTTP contracts or explicit domain seams, never private aggregate helpers, source positions, line counts, or total route/model counts. Remaining workspace-state hooks and FastAPI lifespan/application lifecycle composition remain separate debt.
