...
backing content-hash upload dedup and batch_ingest resume; v31 adds the durable
reports.understanding_json question-understanding contract. PostgreSQL's
checksummed schema manifest currently targets migration v10 and declares
compatibility with SQLite v31.
