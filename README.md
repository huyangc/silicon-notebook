...
- Free-form knowhow tables with Markdown cells, bounded batch-reformat review, readable audit actors, content-aware stable columns, reasoning-backed library-wide empty-cell completion suggestions, deterministic graph projection, history, milestones, and immediately attributed isolated code attachments.
