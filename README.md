...
- Notebook-bound, creator-private Memory with explicit preview/confirmation, retained Ask citation provenance (source, location, excerpt, and original-file identity), and scoped external-Agent access over MCP.
