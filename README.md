...
- "AI 对这个库的理解" keeps a low-cost, background-consolidated summary of a notebook — what it broadly holds, its recurring topics, known gaps, and, privately per member, retrieval phrasing that has worked and questions the library did not answer — surfaced through a viewable/editable panel and quietly folded into reasoning Ask's and Deep Report's own retrieval prompts, never into the answer itself.
