...
full-table scan); v31 adds covering knowledge-relations endpoint/id indexes for
stable, bounded lexical-relation keyset recall. PostgreSQL migration v10 mirrors
those v31 indexes.
