...
vi.mock("./command-catalog-api.ts", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./command-catalog-api.ts")>();
  return {
    ...actual,
...
} from "./command-catalog-panel.tsx";
