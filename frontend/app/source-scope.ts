 ...
 * 「检索范围」的双段计数文案。
 *
 * 这句话出现在来源页签的工具条和问答输入框上方**两处**。收敛成一个纯函数是为了让
 * 两处不一致在结构上不可能发生 —— 它们说的是同一件事,不该有两份拼写。`bases` 为
 * null 表示当前笔记本没挂参考库,那一段整个不出现。
 */
