...
import * as ask from "./ask-api.ts";
import * as kg from "./kg-api.ts";
import * as notebook from "./notebook-api.ts";
import * as report from "./report-api.ts";
import * as source from "./source-api.ts";
import { probeReady } from "./system-api.ts";
...
test("domain clients are directly importable and Ask owns notebook search", async () => {
  const [system, notebook, source, ask, knowledge, report, kg] = await Promise.all([
    import("./system-api.ts"),
    import("./notebook-api.ts"),
    import("./source-api.ts"),
    import("./ask-api.ts"),
    import("./knowledge-api.ts"),
    import("./report-api.ts"),
    import("./kg-api.ts"),
  ]);
