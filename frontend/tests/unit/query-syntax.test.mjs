...
import {
  ...
  quotedPhraseHint,
  quotedPhrases,
} from "../../app/query-syntax.ts";
import { appSourceModules, importsFrom } from "../../test-support/semantic-source.mjs";
...
const PARITY_CASES = [
  ...
  ['"\u{20000}\u{20001}" 是什么', []],
  // 同一段短语重复不算「太密」(闸数的是不同内容)。
  ['"静态时序分析" a "静态时序分析" b "静态时序分析" c "静态时序分析" d "静态时序分析" e "静态时序分析"',
    ["静态时序分析"]],
];
